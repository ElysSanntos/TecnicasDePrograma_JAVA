...
{
if(!Data_Programa3.isValida(dia,mes,ano))
...
public Data_Programa3 (byte dia, byte mes, short ano) throws Exception /*Construtor - Mesmo nome da classe - não tem retorno - 
											void não assumido*/
...
// Versão 1.0 do método Equals
public boolean equals (Data_Programa3 data)
{
