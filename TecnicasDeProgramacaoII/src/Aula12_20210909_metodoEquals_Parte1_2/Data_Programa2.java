...
{
if(!Data_Programa2.isValida(dia,mes,ano))
...
public Data_Programa2 (byte dia, byte mes, short ano) throws Exception /*Construtor - Mesmo nome da classe - não tem retorno - 
											void não assumido*/
