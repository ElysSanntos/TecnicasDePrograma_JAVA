...
public Data_Exercicios (byte dia, byte mes, short ano) throws Exception /*Construtor - Mesmo nome da classe - não 
																		tem retorno - void não assumido*/


{
	/*Valido dia mes e ano, lanço exceção se não for valido. 
 ...
 * 1 - valida se o dia que veio como parametro, junto com o mes e o ano, são validos 
 * - Se não: Lança execção 
...
public Data_Exercicios getDiaAnterior ()/*Não muda a data de referencia*/
{
    // retornar uma data que representa 1 dia antes do
    // objeto acionador deste método, ou seja, do this
	
	
	Data_Exercicios ret=null; /*É preciso realizar um retorno, por isso declaro como null*/
    try
    {
...
public boolean equals (Object obj)
{
	...
	if (this.getClass() != obj.getClass()) return false; // usando um metodo getClass(), herdado de Object 
														 //- Por exemplo se eu passar uma string no parametro, será identificado.
	...
	Data_Exercicios data = (Data_Exercicios) obj; //Preciso fazer o obj ser encarado como um tipo Data, 
												//depois faço a comparação com os atributos da data, fazendo com que eu escreva somente uma vez data
